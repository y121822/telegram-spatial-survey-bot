...
def main():
    """Start the bot. In the case of failure (e.g. caused by a database maintenance or
       ...
       automatically launch another instance from the fully configured template, the
       present start.py file will be called by a cron job on startup and the whole cycle
       will be repeated."""
    count = 21
    while True:
